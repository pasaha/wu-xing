...
if ($this->tmpl['detailbuttons'] == 1){
	echo '<tr class="detailbuttons">'
	.'<td class="detailbutton__left" align="left" width="30%" style="padding-left:48px">'.$this->item->prevbutton.'</td>'
	...
	echo '<td class="detailbutton__right" align="right" width="30%" style="padding-right:48px">'.$this->item->nextbutton.'</td>'
	.'</tr>';
}
*/
...
if ($this->tmpl['detailbuttons'] == 1){
	...
	.'<div class="detailbutton__left">'.$this->item->prevbutton.'</div>';
	echo '<div class="detailbutton__right">'.$this->item->nextbutton.'</div>'
	.'</div>';
}
