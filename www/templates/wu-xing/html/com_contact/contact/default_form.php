<h2 class="componentheading" id="fideback">Обратная связь</h2>
<p>Вы можете связаться с администрацией сайта, воспользовавшись формой обратной связи.</p>
<?php
...
defined( '_JEXEC' ) or die( 'Restricted access' );
	...
	if(isset($this->error)) : ?>
<div class="error-list"><?php echo $this->error; ?></div>
