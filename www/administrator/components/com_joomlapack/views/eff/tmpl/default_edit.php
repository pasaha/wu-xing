...
<form name="adminForm" id="adminForm" method="post" action="<?php echo JURI::base(); ?>index.php">
	...
	<input type="hidden" name="view" value="eff" />
	...
	<table width="100%">
		<tr>
			...
			<td>
				<input type="text" name="fsdir" id="fsdir" value="<?php echo $fsdir ?>" size="60" />
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td>
				<input type="button" value="<?php echo JText::_('EFF_BUTTON_CHECK'); ?>" onclick="testdir();" />
				<input type="button" value="<?php echo JText::_('EFF_BUTTON_RESET'); ?>" onclick="resetdir();" />
			</td>
		</tr>
	</table>
</form>
