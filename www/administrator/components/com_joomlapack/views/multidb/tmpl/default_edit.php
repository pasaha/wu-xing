...
<form name="adminForm" id="adminForm" method="post" action="<?php echo JURI::base(); ?>index.php">
	...
	<input type="hidden" name="task" value="<?php echo JRequest::getCmd('task','add'); ?>" />
	<input type="hidden" name="option" value="com_joomlapack" />
	<input type="hidden" name="view" value="multidb" />
	...
	<table width="100%">
		<tr>
			...
			<td>
				<input type="text" name="host" id="host" value="<?php echo $host ?>" size="60" />
			</td>
		</tr>
		<tr>
			<td><?php echo JHTML::_('tooltip', JText::_('MULTIDB_TIP_PORT'), '', '', JText::_('MULTIDB_LABEL_PORT')) ?></td>
			<td>
				<input type="text" name="port" id="port" value="<?php echo $port ?>" size="5" />
			</td>
		</tr>
		<tr>
			<td><?php echo JHTML::_('tooltip', JText::_('MULTIDB_TIP_USERNAME'), '', '', JText::_('MULTIDB_LABEL_USERNAME')) ?></td>
			<td>
				<input type="text" name="user" id="user" value="<?php echo $user ?>" size="40" />
			</td>
		</tr>
		<tr>
			<td><?php echo JHTML::_('tooltip', JText::_('MULTIDB_TIP_PASSWORD'), '', '', JText::_('MULTIDB_LABEL_PASSWORD')) ?></td>
			<td>
				<input type="text" name="pass" id="pass" value="<?php echo $pass ?>" size="40" />
			</td>
		</tr>
		<tr>
			<td><?php echo JHTML::_('tooltip', JText::_('MULTIDB_TIP_DATABASE'), '', '', JText::_('MULTIDB_LABEL_DATABASE')) ?></td>
			<td>
				<input type="text" name="database" id="database" value="<?php echo $database ?>" size="40" />
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td>
				<input type="button" value="<?php echo JText::_('MULTIDB_BUTTON_CHECK'); ?>" onclick="testdb();" />
			</td>
		</tr>
	</table>
</form>
